...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
        ...
        // Fall back to WebGL1 if WebGL2 isn't available
        if (!isWebGL2) {
        ...
        if (isWebGL2) {
          ...
          halfFloatTexType = halfFloat ? (halfFloat as any).HALF_FLOAT_OES : 0;
        }
    ...
    function getSupportedFormat(
        ...
        const isWebGL2 = (gl as WebGL2RenderingContext).RG !== undefined;
    ...
    class Material {
      ...
      setKeywords(keywords: string[]) {
        ...
        (this.uniforms as any) = getUniforms(program);
