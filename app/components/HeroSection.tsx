...
export default function HeroSection() {
  ...
  return (
    <div 
      ref={containerRef} 
      className="relative bg-[#050107] text-white flex items-center justify-center px-4 min-h-screen"
    >
      ...
      <div className="py-20 space-y-6 relative z-30 text-center max-w-4xl">
        ...
        <div className="flex justify-center">
          <InteractiveHoverButton   onClick={() => router.push("/orgs")}/>
        </div>
      </div>

      <div className="absolute left-4 top-32 flex-col items-start gap-12 z-20 hidden lg:flex">
        <Image
          src="/docker.png"
          alt="Docker"
          width={150}
      ...
      <div className="absolute right-4 top-44 flex-col items-end gap-12 z-20 hidden lg:flex">
        <Image
          src="/tailwind.png"
          alt="Tailwind"
          width={150}
